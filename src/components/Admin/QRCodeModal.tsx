  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="relative w-full max-w-md rounded-2xl bg-white border border-slate-200 shadow-2xl overflow-hidden">
        <button
          onClick={onClose}
          className="absolute right-3 top-3 p-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-600 hover:text-slate-800 transition-all duration-200 shadow-sm z-10"
          aria-label="Close"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="p-6 text-center">
          ...
          <p className="text-slate-600 text-sm break-all mb-6 bg-slate-50 p-3 rounded-xl border border-slate-200">
            {url}
          </p>
          <div className="mx-auto w-full flex items-center justify-center bg-gradient-to-br from-blue-50 to-green-50 p-4 rounded-xl border border-slate-200 shadow-sm">
            <div
              ref={qrWrapRef}
              className="relative bg-white p-3 rounded-xl w-64 h-64 shadow-lg border border-slate-200"
            >
              <QRCode
                value={url}
                size={256}
              ...
              <div
                className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-2xl flex items-center justify-center bg-white overflow-hidden w-[22%] h-[22%] ring-4 ring-white shadow-lg border border-slate-200"
                aria-hidden
              >
          ...
          <div className="mt-6 flex items-center justify-center gap-3 flex-wrap">
            <button
              onClick={handleCopy}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
              <LinkIcon className="w-4 h-4" /> Copy Link
            </button>
            <button
              onClick={handleDownload}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-green-500 to-green-600 text-white hover:from-green-600 hover:to-green-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
